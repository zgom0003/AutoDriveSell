    ...
    <Box sx={{ margin: "20px" }}>
      <Box>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography>Display and analyze sales data here. Include charts or detailed tables as needed.</Typography>
          </AccordionDetails>
        </Accordion>
        <Button variant="contained" onClick={signOut} style={{ width: "150px", marginTop: "10px" }}>
          Sign Out
        </Button>
      </Box>
    </Box>
